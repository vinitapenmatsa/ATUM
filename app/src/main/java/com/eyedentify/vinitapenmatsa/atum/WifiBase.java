...
/**
 * Created by vinitapenmatsa on 1/22/18.
 */
    ...
    private class ScanReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            for (ScanResult scanResult : scanResultList) {
                System.out.println("WIFI found - " + scanResult.SSID);
            ...
            if (!found) {
                System.out.println("*********NO WIFI FOUND*************"  +getWifiSSID());
                ...
                System.out.println("*********WIFI FOUND*************"  +getWifiSSID());
